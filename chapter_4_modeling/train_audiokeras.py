...
This script takes in two folders filled with .wav files, folder A and folder B, and classifies them with nlx-audioclassify features.

It upgrades nlx-audiomodel from simple classification techniques to deep learning approaches.
